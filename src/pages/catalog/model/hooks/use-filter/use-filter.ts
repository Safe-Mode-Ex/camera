...
[Product[], Filter, ChangeCheckableHandler<Filter>, ChangeCheckableHandler<Omit<Filter, 'category'>>] => {
  ...
  return [filtered, activeFilter, changeRadioHandler, changeCheckboxHandler];
};
